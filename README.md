...
![](https://github.com/IAMSUPERE/LAB-06/blob/master/imgs/lab61.jpg)

###คำถาม 6.1 ถ้าพิมพ์ตัวอักษรจำนวนหลายๆ ตัวแล้วกด Enter จะได้ผลอย่างไร ทำไมจึงเป็นเช่นนั้น
```
ออกแค่ตัวอักษรตัวหน้าตัวเดียว
```
...
![](https://github.com/IAMSUPERE/LAB-06/blob/master/imgs/lab62.jpg)
...
![](https://github.com/IAMSUPERE/LAB-06/blob/master/imgs/lab63.jpg)

###คำถาม 6.3 ถ้าเราป้อนตัวอักษรลงไปแทนที่ตัวเลข จะเกิดอะไรขึ้น มีวิธีการป้องกันหรือแก้ไขอย่างไร
```
error
```
![](https://github.com/IAMSUPERE/LAB-06/blob/master/imgs/lab64.jpg)
...
![](https://github.com/IAMSUPERE/LAB-06/blob/master/imgs/lab65.jpg)

###คำถาม 6.4 ถ้าเราป้อนตัวอักษรลงไปแทนที่ตัวเลข จะเกิดอะไรขึ้น เหมือนหรือต่างจากโปรแกรมก่อนหน้านี้อย่างไร
```
ไม่เหมือนเพราะโปรแกรมไม่ hangไม่หยุดการทำงานเหมือนข้อที่แล้ว
```
...
![](https://github.com/IAMSUPERE/LAB-06/blob/master/imgs/lab66.jpg)
